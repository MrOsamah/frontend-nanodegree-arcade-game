...
Player.prototype.update = function(dt) {
    ...
    if (this.moveKey === "left" && this.x > 0) {
        ...
        if (this.y < 50 && this.x < 404 && this.x > 303) {} else {
            this.x = this.x - 101;
        }
    }
...
// function to assign new random x,y values for the key
...
// Only open the gate when the player has 6 keys
...
// Game class used to manage menu and lose and win situation
var Game = function() {
...
// to manage diffrenets states of the game and hide and show some elements
